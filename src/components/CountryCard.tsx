...
export const CountryCard = ( { country } :CountryCardProps ) => {
  return (
    <div className='h-[490px] w-[340px] md:w-[528px] md:h-[670px] xl:w-[264px] xl:h-[336px] rounded-xl bg-white dark:bg-darkBlueDark flex flex-col shadow-md'>
        <figure className='h-[220px] md:h-[320px] xl:h-[160px] w-full '>
            <img className='h-full w-full block object-cover rounded-t-xl' src={country.flags.svg} alt={country.name.official+' flag'} />
        </figure>
